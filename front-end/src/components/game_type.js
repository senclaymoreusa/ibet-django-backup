      ...
      return (
        <div className='rows'>
          ...
          <div>
            ...
            <NavLink to='/game_list/term=Sports' style={{ textDecoration: 'none' }} onClick={()=>{
            ...
            <br/>
            <NavLink to='/game_list/term=Casino' style={{ textDecoration: 'none' }} onClick={()=>{
            ...
            <br/>
            <NavLink to='/game_list/term=Poker' style={{ textDecoration: 'none' }} onClick={()=>{
            ...
            <br/>
            <NavLink to='/game_list/term=Guide' style={{ textDecoration: 'none' }} onClick={()=>{
