    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        this.props.authSignup(
          ...
          axios.get(API_URL + `users/api/sendemail/?from_email_address=${messages.FROM_EMAIL}&to_email_address=${values.email}&email_subject=${messages.SIGNUP_EMAIL_SUBJECT}, ${values.userName}&email_content=${messages.SIGNUP_EMAIL_CONTENT} ${values.email}`)
        }).catch(err => {
