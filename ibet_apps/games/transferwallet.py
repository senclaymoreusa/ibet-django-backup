...
from games.view.aggamesviews import fundTransfer
...
class TransferDeposit():
    ...
    def GADeposit(self):
        return fundTransfer(self.user, self.from_wallet,password, oddtype, actype, gameCategory, credit, fixcredit, cur, agtype)
