...
class GDCasino(models.Model):
    ...
    status = models.SmallIntegerField(choices=GDCASINO_STATUS,default=0)
    gameId = models.CharField(max_length = 200, null= True, blank=True)
    gameType =  models.SmallIntegerField(choices=GDCASINO_GAME_TYPE,default=6,null= True, blank=True)
    transactionId = models.CharField(max_length = 200, null= True, blank=True)
    currency =  models.CharField(max_length=10,null= True, blank=True)
    amount = models.DecimalField(max_digits=20, decimal_places=2, default=0,null= True, blank=True)
    ipAddress = models.CharField(max_length=10,null= True, blank=True)
    gameView = models.CharField(max_length=100,null= True, blank=True)
    clientType = models.CharField(max_length=10,null= True, blank=True)
    tipId = models.IntegerField(default=0,null= True, blank=True)
    cancelReason = models.CharField(choices=GDCASINO_CANCEL_REASON, default='NONE', max_length=20)
