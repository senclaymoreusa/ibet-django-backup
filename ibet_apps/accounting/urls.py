...
urlpatterns = [
    ...
    path('api/qaicash/transaction_status', csrf_exempt(qaicash.transactionStatusUpdate), name='transaction_status_update'),
    path('api/qaicash/confirm', qaicash.confirm_transaction, name="Qaicash_Confirm"),
