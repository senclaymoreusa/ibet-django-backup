        ...
        if post_type == 'deleteChannel':
            ...
            for channel_id, name in CHANNEL_CHOICES:
                if name == deposit_channel:
                    ...
                    break
            delete_channel = get_object_or_404(DepositChannel, thridParty_name=deposit_channel_label)
            ...
            min_amount=min_deposit, max_amount=max_deposit,transaction_fee=transaction_fee,switch=channel_status)
