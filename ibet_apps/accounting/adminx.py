...
from accounting.views.deposit_views import *
from accounting.views.withdrawal_views import *
from accounting.views.channel_list import *
...
#     list_display = (
#         'user_id', 'order_id', 'transaction_id', 'transaction_type', 'amount',
#         'status', 'method', 'channel', 'request_time', 'arrive_time',
