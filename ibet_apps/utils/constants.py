...
REVIEW_STATE_CHOICES = ((0, "Approved"), (1, "Pending"), (2, "Rejected"))
...
ACTIVITY_TYPE = ((0, "Operation"), (1, "Remark"), (2, "Chat"), (3, "Note"))
...
AGENT_STATUS = (("Normal", "Normal"), ("Block", "Block"))

PERMISSION_GROUP = 0
OTHER_GROUP = 1

GROUP_TYPE = ((PERMISSION_GROUP, "Permission"), (OTHER_GROUP, "other"))
...
ASIAPAY_CMDTYPE = (("01", "查询存款订单"), ("02", "查询提款订单"))
ASIAPAY_CASHOUTMETHOD_CHOICES = (("CashSCBatch", "加密货币"), ("cashifacebatch", "代付"))
...
PRODUCT_IMG_URL = (
    "https://pathtoproductimage.jpg"
)  # dummy image, will be replaced with actual company URL later
...
PAYPAL_CLIENT_ID = (
    "AXoM7FKTdT8rfh-SI66SlAWd_P85YSsNfTvm0zjB0-AhJhUhUHTuXi4L87DcgkxLSLPYKCMO5DVl2pDD"
)
PAYPAL_CLIENT_SECRET = (
    "ENKmcu7Sci-RHW2gHvzmeUbZvSaCuwRiEirKH0_TkYo4AZWbVnfevS-hxq6cS6sevLU5TB3SMfq85wSB"
)
